...
namespace Tracbel.Crm.Infraestrutura.Migrations
{
    ...
    [Migration("20260914170927_IntegracaoDoArtLinhaDeProdutoVendaEVinculo")]
    partial class IntegracaoDoArtLinhaDeProdutoVendaEVinculo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Tracbel.Crm.Dominio.Documento.Vinculo", b =>
                {
                    ...
                    b.ToTable("Vinculo", "documento", t =>
                        {
                            t.HasCheckConstraint("CK_Vinculo_Entidade", "[Entidade] COLLATE Latin1_General_BIN2 IN ('Alerta', 'AlteracaoDeCampo', 'AreaPlantadaNoMunicipio', 'CampoAuditado', 'CampoPersonalizado', 'CanalContato', 'Carteira', 'CarteiraMunicipio', 'Catalogo', 'CatalogoItem', 'ChaveExterna', 'Cliente', 'ClienteCarteira', 'ClienteContato', 'CompartilhamentoDeRegistro', 'CompradorPendente', 'ConjuntoPermissao', 'ConsentimentoComunicacao', 'Contato', 'CorrespondenciaDaOrigem', 'DivergenciaDeIntegracao', 'Documento', 'Empresa', 'Endereco', 'Equipamento', 'Equipe', 'EquipeMembro', 'EventoDeAcesso', 'ExecucaoRegra', 'Familia', 'Fase', 'FaturamentoDoCliente', 'FaturamentoSemCliente', 'Fonte', 'FonteCampo', 'Formulario', 'HierarquiaComercial', 'Interacao', 'InteracaoParticipante', 'ItemConjuntoPermissao', 'ItemDeProposta', 'Lead', 'LeituraDeHorimetro', 'LinhaDeNegocio', 'LinhaDeProduto', 'Marca', 'MensagemDeSaida', 'MensagemDescartada', 'Meta', 'Modelo', 'MotivoDePerda', 'Municipio', 'MunicipioDaAreaDeAtuacao', 'PassagemDeFase', 'Pergunta', 'Permissao', 'PontoDeSincronismo', 'Praca', 'Preenchimento', 'Processo', 'Recepcao', 'RegistroDeOrigem', 'Regra', 'RegraDePotencial', 'Relatorio', 'ResponsavelPeloMunicipio', 'Resposta', 'Resultado', 'Sistema', 'Tarefa', 'TipoProcesso', 'TipoTarefa', 'TratadorDeEvento', 'Usuario', 'UsuarioConjuntoPermissao', 'VendaDeMaquina', 'VendaPerdida', 'Vinculo', 'VinculoDeClienteComEquipamento')");
                        });
                });
                    ...
                    b.ToTable("Equipamento", "frota", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Equipamento_ModeloPendente", "[ModeloId] IS NOT NULL OR [Origem] <> 'Crm'");
                    ...
                    b.ToTable("Recepcao", "integracao", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Recepcao_Entidade", "[Entidade] COLLATE Latin1_General_BIN2 IN ('Alerta', 'AlteracaoDeCampo', 'AreaPlantadaNoMunicipio', 'CampoAuditado', 'CampoPersonalizado', 'CanalContato', 'Carteira', 'CarteiraMunicipio', 'Catalogo', 'CatalogoItem', 'ChaveExterna', 'Cliente', 'ClienteCarteira', 'ClienteContato', 'CompartilhamentoDeRegistro', 'CompradorPendente', 'ConjuntoPermissao', 'ConsentimentoComunicacao', 'Contato', 'CorrespondenciaDaOrigem', 'DivergenciaDeIntegracao', 'Documento', 'Empresa', 'Endereco', 'Equipamento', 'Equipe', 'EquipeMembro', 'EventoDeAcesso', 'ExecucaoRegra', 'Familia', 'Fase', 'FaturamentoDoCliente', 'FaturamentoSemCliente', 'Fonte', 'FonteCampo', 'Formulario', 'HierarquiaComercial', 'Interacao', 'InteracaoParticipante', 'ItemConjuntoPermissao', 'ItemDeProposta', 'Lead', 'LeituraDeHorimetro', 'LinhaDeNegocio', 'LinhaDeProduto', 'Marca', 'MensagemDeSaida', 'MensagemDescartada', 'Meta', 'Modelo', 'MotivoDePerda', 'Municipio', 'MunicipioDaAreaDeAtuacao', 'PassagemDeFase', 'Pergunta', 'Permissao', 'PontoDeSincronismo', 'Praca', 'Preenchimento', 'Processo', 'Recepcao', 'RegistroDeOrigem', 'Regra', 'RegraDePotencial', 'Relatorio', 'ResponsavelPeloMunicipio', 'Resposta', 'Resultado', 'Sistema', 'Tarefa', 'TipoProcesso', 'TipoTarefa', 'TratadorDeEvento', 'Usuario', 'UsuarioConjuntoPermissao', 'VendaDeMaquina', 'VendaPerdida', 'Vinculo', 'VinculoDeClienteComEquipamento')");
                    ...
                    b.ToTable("CampoPersonalizado", "metadado", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_CampoPersonalizado_Entidade", "[Entidade] COLLATE Latin1_General_BIN2 IN ('Alerta', 'AlteracaoDeCampo', 'AreaPlantadaNoMunicipio', 'CampoAuditado', 'CampoPersonalizado', 'CanalContato', 'Carteira', 'CarteiraMunicipio', 'Catalogo', 'CatalogoItem', 'ChaveExterna', 'Cliente', 'ClienteCarteira', 'ClienteContato', 'CompartilhamentoDeRegistro', 'CompradorPendente', 'ConjuntoPermissao', 'ConsentimentoComunicacao', 'Contato', 'CorrespondenciaDaOrigem', 'DivergenciaDeIntegracao', 'Documento', 'Empresa', 'Endereco', 'Equipamento', 'Equipe', 'EquipeMembro', 'EventoDeAcesso', 'ExecucaoRegra', 'Familia', 'Fase', 'FaturamentoDoCliente', 'FaturamentoSemCliente', 'Fonte', 'FonteCampo', 'Formulario', 'HierarquiaComercial', 'Interacao', 'InteracaoParticipante', 'ItemConjuntoPermissao', 'ItemDeProposta', 'Lead', 'LeituraDeHorimetro', 'LinhaDeNegocio', 'LinhaDeProduto', 'Marca', 'MensagemDeSaida', 'MensagemDescartada', 'Meta', 'Modelo', 'MotivoDePerda', 'Municipio', 'MunicipioDaAreaDeAtuacao', 'PassagemDeFase', 'Pergunta', 'Permissao', 'PontoDeSincronismo', 'Praca', 'Preenchimento', 'Processo', 'Recepcao', 'RegistroDeOrigem', 'Regra', 'RegraDePotencial', 'Relatorio', 'ResponsavelPeloMunicipio', 'Resposta', 'Resultado', 'Sistema', 'Tarefa', 'TipoProcesso', 'TipoTarefa', 'TratadorDeEvento', 'Usuario', 'UsuarioConjuntoPermissao', 'VendaDeMaquina', 'VendaPerdida', 'Vinculo', 'VinculoDeClienteComEquipamento')");
            ...
            modelBuilder.Entity("Tracbel.Crm.Dominio.Seguranca.Permissao", b =>
                {
                    ...
                    b.ToTable("Permissao", "seguranca", t =>
                        {
                            t.HasCheckConstraint("CK_Permissao_Entidade", "[Entidade] COLLATE Latin1_General_BIN2 IN ('Alerta', 'AlteracaoDeCampo', 'AreaPlantadaNoMunicipio', 'CampoAuditado', 'CampoPersonalizado', 'CanalContato', 'Carteira', 'CarteiraMunicipio', 'Catalogo', 'CatalogoItem', 'ChaveExterna', 'Cliente', 'ClienteCarteira', 'ClienteContato', 'CompartilhamentoDeRegistro', 'CompradorPendente', 'ConjuntoPermissao', 'ConsentimentoComunicacao', 'Contato', 'CorrespondenciaDaOrigem', 'DivergenciaDeIntegracao', 'Documento', 'Empresa', 'Endereco', 'Equipamento', 'Equipe', 'EquipeMembro', 'EventoDeAcesso', 'ExecucaoRegra', 'Familia', 'Fase', 'FaturamentoDoCliente', 'FaturamentoSemCliente', 'Fonte', 'FonteCampo', 'Formulario', 'HierarquiaComercial', 'Interacao', 'InteracaoParticipante', 'ItemConjuntoPermissao', 'ItemDeProposta', 'Lead', 'LeituraDeHorimetro', 'LinhaDeNegocio', 'LinhaDeProduto', 'Marca', 'MensagemDeSaida', 'MensagemDescartada', 'Meta', 'Modelo', 'MotivoDePerda', 'Municipio', 'MunicipioDaAreaDeAtuacao', 'PassagemDeFase', 'Pergunta', 'Permissao', 'PontoDeSincronismo', 'Praca', 'Preenchimento', 'Processo', 'Recepcao', 'RegistroDeOrigem', 'Regra', 'RegraDePotencial', 'Relatorio', 'ResponsavelPeloMunicipio', 'Resposta', 'Resultado', 'Sistema', 'Tarefa', 'TipoProcesso', 'TipoTarefa', 'TratadorDeEvento', 'Usuario', 'UsuarioConjuntoPermissao', 'VendaDeMaquina', 'VendaPerdida', 'Vinculo', 'VinculoDeClienteComEquipamento')");
