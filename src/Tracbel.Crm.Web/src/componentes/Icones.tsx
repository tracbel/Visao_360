...
function Svg({ tamanho = 18, children }: Props & { children: React.ReactNode }) {
  return (
    <svg width={tamanho} height={tamanho} viewBox="0 0 24 24" {...traco}>
      {children}
    </svg>
  );
}

export function IconeVisao360(p: Props) {
  return (
    <Svg {...p}>
...
export function IconeAgenda(p: Props) {
  return (
    <Svg {...p}>
...
export function IconeCobertura(p: Props) {
  return (
    <Svg {...p}>
...
export function IconePipeline(p: Props) {
  return (
    <Svg {...p}>
      <path d="M22 2L11 13" />
...
export function IconeClientes(p: Props) {
  return (
    <Svg {...p}>
...
export function IconeEquipamentos(p: Props) {
  return (
    <Svg {...p}>
...
export function IconeFunil(p: Props) {
  return (
    <Svg {...p}>
...
export function IconePerformance(p: Props) {
  return (
    <Svg {...p}>
...
export function IconeCoberturaRegional(p: Props) {
  return (
    <Svg {...p}>
      <path d="M3 3v18h18" />
...
export function IconeBusca({ tamanho = 16 }: Props) {
  return (
    <svg width={tamanho} height={tamanho} viewBox="0 0 24 24" {...traco} strokeWidth={2}>
...
export function IconeNotificacoes({ tamanho = 20 }: Props) {
  return (
    <Svg tamanho={tamanho}>
...
export function IconeSincronizacao({ tamanho = 20 }: Props) {
  return (
    <Svg tamanho={tamanho}>
      <path d="M23 4v6h-6" />
      <path d="M1 20v-6h6" />
...
/** Marca da Tracbel Agro — o retângulo verde com o triângulo amarelo. */
export function LogoTracbel() {
  return (
    <svg
      ...
      viewBox="0 0 32 32"
      fill="none"
      aria-label="Tracbel Agro"
    >
      <rect width="32" height="32" rx="6" fill="#367C2B" />
