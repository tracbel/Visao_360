...
public sealed class MigracaoNoContainerTestes
{
    ...
    public void A_cadeia_de_migracoes_cria_os_oito_schemas_e_as_cinquenta_e_cinco_tabelas()
    {
        ...
        porSchema.Should().BeEquivalentTo(new Dictionary<string, int>
        {
            ...
            ["integracao"] = 9,
            ["metadado"] = 2
        }, "é a conta do documento 14, seção 2.1 — 58 tabelas de modelo em 8 schemas, no banco de " +
           ...
           "agropecuária a 66 as duas dos preços de mercado e a 67 a dos custos de produção. A cadeia inteira roda aqui, do zero: é o que prova que a remoção — e o " +
