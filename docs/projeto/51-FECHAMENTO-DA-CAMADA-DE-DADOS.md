...
1. **Quatro das dez perguntas não fecham com trabalho de engenharia.** Elas dependem de **dado interno que
   ...
   **Errata de 24/09/2026:** **duas das quatro saíram.** A **D-P08 foi decidida** — o ART é a fonte canônica
   das unidades (doc 48 §5.3) — e a **#69 foi entregue**: o território lê `frota.VendaDeMaquina` por município
   e por categoria, e a captura e a oportunidade em unidades passam a depender só do **denominador**, que é a
   D-P01. Restam a **#70** (preço de máquina) e as decisões do comercial.
...
| **D-P08** fonte oficial das vendas Tracbel | **DECIDIDA em 24/09/2026** (doc 48 §5.3) | **o ART é a fonte canônica das unidades**; o Protheus segue como faturamento **em reais**; a API GN depois, só para o financiamento. A sub-decisão **D-P08.1 — qual das três datas** — foi fechada no mesmo dia: **a do faturamento** (doc 48 §5.4) | destravou **Captura**, **Oportunidade** e **Performance**: a leitura de `frota.VendaDeMaquina` pelo território foi entregue no mesmo dia (#69). O que falta é o denominador, que é a D-P01 | decidida |
...
| 6 | **Quanto a Tracbel captura?** | 🟨 | **ART** — `frota.VendaDeMaquina`, **D-P08 decidida em 24/09** (doc 48 §5.3) | **#69** ✔ feito; #162 | **o numerador chegou**: o território lê as unidades por município e por categoria, e a captura depende agora do **denominador** — a D-P01. Falta também o ART voltar a rodar: está desligado para ajuste de dados | registrar as regras de potencial (linha 1) e religar o serviço do ART | **KPI Captura** e a aba Captura da Performance, com a quebra por categoria |
| 7 | **Quanto ainda não captura?** (Oportunidade) | 🟨 | derivado | **#69** ✔ feito, #70, #162 | o mesmo da linha 6 — em unidades ela sai junto com a captura; **em reais** ainda depende do preço de máquina (linha 3) | a mesma da linha 6; o R$ fica para a #70 | **KPI Oportunidade** e a aba "Não capturado", que já mostra as unidades |
| 8 | **Onde estão os municípios com maior oportunidade?** | 🟨 | mapa de potencial | #72 ✔; **#69** ✔ feito | o mapa **já ranqueia por potencial**, e agora cada município traz também as **unidades vendidas** — o ranking por "potencial − vendas" passa a ser conta de tela, não falta de dado | ranquear pela diferença assim que a D-P01 der o potencial de todas as culturas | o mapa C e a tabela de municípios |
...
| ~~**#69**~~ **ENTREGUE em 24/09** — D-P08 decidida, de-para, leitura e quebra por categoria | — | **Captura**, **Oportunidade em unidades** e o bloco **Performance** já saem; os três esperam agora só o denominador da **D-P01** |
