...
| Tarefa mensal | `TracbelCrmPrecos`, **todo dia 20 às 04:00**, como SYSTEM (issue 66) — `/SC MONTHLY /D 20`, sem `/M`. Roda `--somente-precos`: CONAB, Socicana e dólar PTAX. É mensal porque a CONAB só publica os últimos 12 meses — um ano sem rodar perderia meses para sempre (documento 48, §2.4) |
