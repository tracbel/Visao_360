...
| I-06 | **Unidade da quantidade não é guardada.** A coluna chama `QuantidadeProduzidaToneladas`, mas o IBGE publica alguns produtos em mil frutos | produtividade e receita de um produto nessa unidade sairiam erradas | unidade por produto e ano pelas notas da tabela (o campo de unidade do SIDRA é o da variável); renomear sem perda (IM-03) |
