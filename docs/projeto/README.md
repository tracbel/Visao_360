...
| 23A | [Matriz das 39 rotas](23A-MATRIZ-DAS-ROTAS.md) | o inventário da API rota por rota (issue #3), com arquivo e linha, caso de uso, tabelas lidas, se grava, teste, tela que consome e a fase que altera cada uma; os quatro achados medidos em 19/09/2026 — **0 de 39 rotas exigem permissão** embora o motor exista, **7 sem nenhum teste HTTP**, **4 sem consumidor na tela** (as três do legado e `/municipios`, que é justamente a que fecharia o campo de município) e **11 rotas que o documento 23 não descreve**; e a proposta de teste de arquitetura "toda rota declara permissão", que entra com a #46 |
