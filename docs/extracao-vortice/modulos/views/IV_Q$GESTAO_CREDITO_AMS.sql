/* ==============================================================
   Objeto ..........: dbo.IV_Q$GESTAO_CREDITO_AMS
   Tipo ............: VIEW
   Criado em .......: 2022-04-20 15:03:09
   Modificado em ...: 2022-12-01 15:08:52
   Linhas ..........: 15
   Escreve em tabela: nao
   Tabelas referidas: GE_Pessoa, IV_Formulario, IV_Q_GESTAO_CREDITO_AMS, IV_Questionario
   Fonte: banco CRM (Vortice CRM / Tracbel) - extracao somente leitura
   ============================================================== */

CREATE VIEW dbo.IV_Q$GESTAO_CREDITO_AMS
AS
SELECT TBASE.SeqPessoa, TBASE.NomeRazao AS Pessoa, QST.SeqQuestionario, FRM.SeqFormulario, FRM.Descricao AS Formulario, QST.DtaRealizacao, QST.UsuInclusao, QST.DtaAlteracao, QST.UsuAlteracao, QST.Obs AS Observacao, 
                  ...
                  TABF.STATUS_PROCESSO, TABF.PROBABILIDADE, TABF.COM_CONTRATO
FROM     dbo.IV_Q_GESTAO_CREDITO_AMS AS TABF INNER JOIN
