/* ==============================================================
   Objeto ..........: dbo.PR_COL_MIGPESSOA_ATV
   Tipo ............: SQL_STORED_PROCEDURE
   Criado em .......: 2024-12-27 20:21:49
   Modificado em ...: 2024-12-30 17:19:23
   Linhas ..........: 414
...
CREATE procedure [dbo].[PR_COL_MIGPESSOA_ATV] 
AS


/*
-- autor: AMAURY 25/10/2024
   objetivo: Migrar pessoas ativas com cnpj da norte para noroeste
   log de alterações: 25/10/2024 - Criação da rotina, aguardando cliente validar documentação de migração
                      01/11/2024 - Cliente validou os dados testando e finalizando criação da rotina
*/	
	...
	FOR
		...
		WHERE 1=1
		  AND MP.DESCRICAO = 'Ativo com CNPJ Inexistente'  --- 'Ativo com CNPJ'
		  AND MP.SEQPESSOA in ( 1501 )
