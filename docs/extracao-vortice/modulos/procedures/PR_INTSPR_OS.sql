/* ==============================================================
   Objeto ..........: dbo.PR_INTSPR_OS
   Tipo ............: SQL_STORED_PROCEDURE
   Criado em .......: 2015-09-30 16:52:29
...
CREATE procedure [dbo].[PR_INTSPR_OS]
AS
...
(SELECT FIRST 1 REG.FUNCIOCOD FROM T04REGCDT REG 
	...
	WHERE OS.ORDGERIDTSTOS = 3
	  AND  OS.ORDGERDATABEROS >= (EXTRACT (YEAR FROM CURRENT_DATE-90) * 10000 +
EXTRACT (MONTH FROM CURRENT_DATE-90) * 100 +
EXTRACT (DAY FROM CURRENT_DATE-90))
	')
